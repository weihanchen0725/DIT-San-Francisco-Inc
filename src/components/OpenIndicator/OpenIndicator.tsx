      ...
      >
        ...
        {status.nextChange && (
          <>
            ...
            <span className="text-sm text-gray-600 dark:text-gray-400">{status.nextChange}</span>
          </>
        )}
                ...
                return (
                  <li
                    ...
                    className={`flex justify-between items-center py-1.5 px-2 rounded-lg text-sm ${
                      isToday ? 'bg-brand-yellow/10 dark:bg-brand-yellow/20' : ''
                    }`}
                  >
                    <span
                      className={`${
                    ...
                    >
                      {t(day)}
                      {isToday && (
                        <span className="ml-1.5 text-xs text-brand-yellow">({t('today')})</span>
                      )}
                    </span>
                    <span
                      className={`${
